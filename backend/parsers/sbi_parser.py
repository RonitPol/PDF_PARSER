# backend/parsers/sbi_parser.py
from .base_parser import BaseCreditCardParser
import re

class SBIParser(BaseCreditCardParser):
    ...
    def get_card_number_last4(self):
        ...
        # Check for SBI sample pattern
        if 'XXXX XXXX XXXX 1234' in self.text:
            return "1234"
        return "Not Found"
